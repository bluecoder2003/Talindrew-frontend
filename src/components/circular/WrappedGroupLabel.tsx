...
import { circularLabel, svgText } from "./styles";
...
export const WrappedGroupLabel = (props: WrappedGroupLabelProps) => {
  ...
  return (
    <g key={key} onMouseLeave={() => setHoveredGroup("")}>
      <path className="la-vz-label-line" d={linePath} style={{ stroke: 'white', strokeWidth: '1px', fill: 'none' }} />
      <rect fill="rgba(0, 0, 0, 0.8)" height={rectHeight} stroke="none" width={rectWidth} {...rectCoor} />
      ...
      <rect fill="none" height={rectHeight} stroke="white" strokeWidth={1.5} width={rectWidth} {...rectCoor} />
    </g>
  );
};
